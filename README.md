...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/oceancolor-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13924&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/oceancolor-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `oceancolor` can be installed with:

```
conda install oceancolor
```

It is possible to list all of the versions of `oceancolor` available on your platform with:
